...
import { IColumnRequest } from '@/api/module/types/column'
...
const formData = ref<IColumnRequest>({
  id: null,
  title: '',
  cover: '',
  try: '',
...
const open = (title: string, row?: IColumnRequest) => {
  visible.value = true
  ...
  <div class="edit-dialog">
    ...
    >
      ...
      >
        ...
        <el-form-item label="连载" prop="status">
